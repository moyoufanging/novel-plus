...
public interface BookService {
    ...
    //增加一个下一章的链接,不能随便添加,添加了会报错
    void addnextPage1(long novel_id,long book_id,String link_url,String nextpage_name,String nextpage_desc,Integer thumbsup_count,Integer reply_count);
}
