...
public class AuthorServiceImpl implements AuthorService {
    ...
    public String register(Long userId, Author author) {
        ...
        if (true) {
            ...
            //邀请码无效
            //为什么邀请码不对?
            System.out.println("邀请码AuthorCodeDynamicSqlSupport.inviteCode---------"+AuthorCodeDynamicSqlSupport.inviteCode);
            System.out.println("邀请码---author.getInviteCode()-------"+author.getInviteCode());
            System.out.println("邀请码AuthorCodeDynamicSqlSupport.isUse-------"+AuthorCodeDynamicSqlSupport.isUse);
            System.out.println("邀请码AuthorCodeDynamicSqlSupport.validityTime--------"+AuthorCodeDynamicSqlSupport.validityTime);
            System.out.println("邀请码---currentDate-------"+currentDate);
