...
public final class BookDynamicSqlSupport {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public static final SqlColumn<Integer> isAlonePossess = book.isAlonePossess;
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public static final class Book extends SqlTable {
        public final SqlColumn<Long> id = column("id", JDBCType.BIGINT);
        public final SqlColumn<Integer> isAlonePossess = column("is_alone_possess", JDBCType.INTEGER);
